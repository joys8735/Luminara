...
import { X, DollarSign, TrendingUp, TrendingDown, Newspaper, AlertCircle, BarChart2 } from 'lucide-react';
        ...
        <div className="relative space-y-5">
              ...
              <div>
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-blue-500/10 text-blue-400 border border-blue-500/30">
                    Impact ×{pair.mult > 1.1 ? pair.mult.toFixed(2) : pair.mult.toFixed(1)}
                  </span>
                </div>
                <div className="flex flex-wrap items-center gap-2 mt-1 text-[11px] text-[#707070]">
                  <span>Market sentiment prediction</span>
                  <span className="w-1 h-1 rounded-full bg-blue-500" />
                  <span>News-driven outcome</span>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              <div className="ui-card relative rounded-2xl p-5 space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-[10px] text-[#707070]">Market Event</div>
                ...
                <div className="grid grid-cols-2 gap-3 text-xs">
                  <div className="ui-inner rounded-lg p-3">
                    <div className="text-[10px] text-[#707070] mb-1">Sentiment score</div>
                    <div className="text-lg font-bold text-blue-400">{pair.price.toFixed(1)}</div>
                  </div>
                  <div className="ui-inner rounded-lg p-3">
                    <div className="text-[10px] text-[#707070] mb-1">Market mood</div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-[11px]">
                    ...
                    <span className="text-[#707070]">Impact level:</span>
                    <span className="text-yellow-400 font-semibold">
                      {Math.abs(pair.change) > 3 ? 'High' : Math.abs(pair.change) > 1.5 ? 'Medium' : 'Low'}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-[11px]">
                    <BarChart2 className="w-4 h-4 text-[#22c1c3]" />
                    <span className="text-[#707070]">Market participants:</span>
                    <span className="ui-bg-text font-semibold">{pair.vol}</span>
                  </div>
                </div>

                <div className="ui-inner rounded-lg p-3 text-[11px] text-[#a0a0a0]">
                  <div className="font-semibold text-[#eee] mb-1">About this prediction</div>
                  Predict how the market will react to {pair.pair}. Your prediction will be settled based on market 
                  sentiment indicators and price movements following the news event. Higher impact events offer greater 
                  potential returns.
                </div>
              </div>
              ...
              <div className="ui-card rounded-2xl p-4 space-y-3">
                <div className="text-xs font-semibold ui-bg-text">Sentiment breakdown</div>
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-[11px]">
                    <span className="text-[#707070]">Positive sentiment</span>
                  ...
                  <div className="flex items-center justify-between text-[11px]">
                    <span className="text-[#707070]">Negative sentiment</span>
            ...
            <div className="space-y-3">
              ...
              <div className="ui-inner rounded-lg p-3 text-[11px] text-[#a0a0a0]">
                <div className="font-semibold text-[#eee] mb-1">How news predictions work</div>
                <ul className="space-y-1">
                  <li>• BULLISH: Predict positive market reaction to the news</li>
                  <li>• BEARISH: Predict negative market reaction to the news</li>
                  <li>• Settled based on market sentiment indicators</li>
                  <li>• Higher impact events = higher potential multipliers</li>
                  <li>• Results determined by aggregate market movement</li>
                </ul>
              </div>
            </div>
          </div>
