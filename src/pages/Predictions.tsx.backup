...
const calculateLivePnL = (bet: Bet, currentPrice: number) => {
      ...
      <div className="ui-card rounded-2xl p-5 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <h1 className="text-2xl font-semibold ui-bg-text ">
              Crypto Predictions Arena
            </h1>
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {[
                ...
                <div key={i} className="px-3 py-2 rounded-xl ui-inner text-xs">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl ui-inner px-4 py-2 text-xs md:text-xs font-medium ui-bg-text  hover:bg-[#0b1120]/10 transition-all"
            >
              <HistoryIcon className="w-3 h-3 text-[#3b82f6]" />
              Prediction history
            </button>
  ...
  {/* Airdrop streak (залишаєш) */}
  
  {/* Заміни Trader profile на Price Challenge */}
  <DailyPriceChallenge btcPrice={btcPrice} />
  
  {/* AI Recommendation (залишаєш) */}
</div>
          ...
          <div className="relative z-10 space-y-3 text-xs">
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-full bg-[#050816] flex items-center justify-center border border-[#1f1f1f]">
              ...
              <span className="rounded-full border border-[#1f1f1f] bg-[#050816] px-2 py-0.5 text-[10px] text-[#a0a0a0]">
        ...
        {hasPremium ? (
          <div className="ui-card rounded-2xl p-4 relative overflow-hidden border border-[#1f1f1f]/20">
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "url(https://img.freepik.com/free-photo/3d-abstract-network-communications-background-with-plexus-design_1048-16800.jpg)",
              }}
            />
            <div className="relative z-10 space-y-3 text-xs">
              <div className="flex items-center justify-between gap-2">
                ...
                {hotPair && (
                  <span className="rounded-full border border-[#1f1f1f] bg-[#050816] px-2 py-0.5 text-[10px] text-[#eee]">
    ...
    <div className="inline-flex items-center gap-1 self-start rounded-full  text-[10px] text-[#707070]">
              ...
              <div className="space-y-3">
                {pairs.map((pair) => {
                  ...
                  return (
                    <div
                      key={pair.id}
                      className="ui-inner rounded-2xl px-3 py-3 border border-[#1f1f1f]/5 hover:border-[#3b82f6]/40 transition-all"
                    >
                      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                        ...
                        <div className="w-full md:w-[170px] flex flex-col gap-2">
                          <button
                            ...
                            className="w-full py-2 rounded-lg ui-card hover:bg-[#2563eb]/40 text-[12px] transition-all"
                          >
                            Place prediction
      ...
      <div className="h-2 bg-[#3b82f6]" style={{height: '5px', width: `${sessionStats.winRate}%`}} />
    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-4">
                        ...
                        <span className="text-[10px] px-2 py-0.5 rounded-full border border-[#1f1f1f] text-[#a0a0a0]">
    ...
    <div className="absolute -bottom-1 -left-1 w-3 h-3 bg-cyan-300 rounded-full blur-sm"></div>
                      ...
                      <div className="space-y-1">
                        <div className="h-2 rounded-full mb-1 bg-[#020617] relative overflow-hidden">
                          {(() => {
                            ...
                            return (
                              <>
                                <div className="absolute inset-0 bg-gradient-to-r from-[#3b82f6] via-[#22c1c3] to-[#a855f7] opacity-60" />
                                <div
                    ...
                    <div className="space-y-3">
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-8 pr-3 font-semibold py-4 ui-card rounded-xl ui-bg-text  text-sm outline-none focus:border-[#3b82f6]/10"
                        />
                      </div>
                      <div className="flex flex-wrap gap-2 text-[11px]">
                        {[10, 25, 50, 100, 200].map((v) => (
                          <button
                            ...
                            className="px-3 py-1 rounded-full border border-[#1f1f1f] bg-[#eee]/5 text-[#a0a0a0] hover:border-[#3b82f6]/70"
                          >
                            {v} {currency}
                          </button>
                        ))}
      ...
      <AnimatePresence>
        {resultPopup && (
          <motion.div
            className="fixed inset-0 bg-black/90 backdrop-blur ml-56 flex items-center justify-center z-30 p-4"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          >
            <motion.div
              className="relative ui-card rounded-2xl p-6 max-w-sm w-full"
              initial={{ scale: 0.9, opacity: 0, y: 20 }}
              animate={{ scale: 1, opacity: 1, y: 0 }}
              exit={{ scale: 0.9, opacity: 0, y: 20 }}
            >
              <div className="pointer-events-none absolute -inset-0 rounded-2xl bg-[radial-gradient(circle_at_top,_#3b82f6_0,_transparent_55%)] opacity-40" />
              <div className="relative text-center space-y-3 text-sm">
                <div className="flex items-center justify-center gap-3 mb-1">
                  <div className="w-[300px] h-12 rounded-full bg-[#050816] flex items-center justify-center border border-[#1f1f1f]/20">
                    <Activity
                      className={`w-4 h-4 ${
                    ...
                    />
                    <h3 className="text-sm pl-3  ui-bg-text ">
                      {resultPopup.result === "win"
                        ? "You won the round!"
                        : "Prediction lost"}
                    </h3>
                ...
                <button
                  ...
                  className="mt-2 w-64 py-2 rounded-lg btn-primary text-white text-xs font-medium hover:opacity-90 transition-all"
                >
                  Done
                </button>
              </div>
